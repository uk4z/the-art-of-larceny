    ...
    match level {
        ...
        Level::Office => {
            Some(
                vec![ 
                    GuardBundle { 
                        position: WorldPosition { x:  2198.0 , y:  1858.0 },
                        orientation: Orientation(Quat::from_rotation_z(3.0*PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2198.0 , y:  1858.0 },
                                WorldPosition { x:  2198.0 , y:  1505.0 },
                                WorldPosition { x:  2198.0 , y:  1858.0 },
                                WorldPosition { x:  1683.0 , y:  1989.0 },
                                WorldPosition { x:  906.0 , y:  1926.0 },
                                WorldPosition { x:  1683.0 , y:  1989.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  2198.0 , y:  1505.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                                Waiting {
                                    position: WorldPosition { x:  906.0 , y:  1926.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  2708.0 , y:  1264.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2708.0 , y:  1264.0 },
                                WorldPosition { x:  2708.0 , y:  562.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  2708.0 , y:  1264.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  2708.0 , y:  562.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  2547.0 , y:  562.0 },
                        orientation: Orientation(Quat::from_rotation_z(3.0*PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2547.0 , y:  562.0 },
                                WorldPosition { x:  2547.0 , y:  1264.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  2547.0 , y:  562.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  2547.0 , y:  1264.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  812.0 , y:  562.0 },
                        orientation: Orientation(Quat::from_rotation_z(3.0*PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  812.0 , y:  562.0 },
                                WorldPosition { x:  812.0 , y:  1264.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  812.0 , y:  562.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  812.0 , y:  1264.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  652.0 , y:  1264.0 },
                        orientation: Orientation(Quat::from_rotation_z(3.0*PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  652.0 , y:  1264.0 },
                                WorldPosition { x:  652.0 , y:  562.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  652.0 , y:  1264.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  652.0 , y:  562.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  2320.0 , y:  928.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/4.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                            run_timer: Timer::new(Duration::from_millis(250), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2320.0 , y:  928.0 },
                                WorldPosition { x:  2220.0 , y:  746.0 },
                                WorldPosition { x:  1789.0 , y:  746.0 },
                                WorldPosition { x:  1668.0 , y:  877.0 },
                                WorldPosition { x:  987.0 , y:  998.0 },
                                WorldPosition { x:  1668.0 , y:  877.0 },
                                WorldPosition { x:  1789.0 , y:  746.0 },
                                WorldPosition { x:  2220.0 , y:  746.0 },
                            ],
                            waitings: vec![
                                ...
                                Waiting {
                                    position: WorldPosition { x:  987.0 , y:  998.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  3271.0 , y:  846.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/4.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  3271.0 , y:  846.0 },
                                WorldPosition { x:  2982.0 , y:  846.0 },
                                WorldPosition { x:  2982.0 , y:  1481.0 },
                                WorldPosition { x:  3271.0 , y:  1481.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  0.0 , y:  0.0 },
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  1113.0 , y:  1262.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/4.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  1113.0 , y:  1262.0 },
                                WorldPosition { x:  1359.0 , y:  1395.0 },
                                WorldPosition { x:  1760.0 , y:  1240.0 },
                                WorldPosition { x:  1359.0 , y:  1395.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                ...
                                Waiting {
                                    position: WorldPosition { x:  1760.0 , y:  1240.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  592.0 , y:  246.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/4.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  625.0 , y:  246.0 },
                                WorldPosition { x:  1642.0 , y:  246.0 },
                                WorldPosition { x:  1642.0 , y:  200.0 },
                                WorldPosition { x:  1642.0 , y:  246.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  625.0 , y:  246.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                                Waiting {
                                    position: WorldPosition { x:  1642.0 , y:  200.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  1642.0 , y:  200.0 },
                                WorldPosition { x:  1642.0 , y:  246.0 },
                                WorldPosition { x:  1978.0 , y:  354.0 },
                                WorldPosition { x:  2271.0 , y:  238.0 },
                                WorldPosition { x:  2740.0 , y:  238.0 },
                                WorldPosition { x:  2271.0 , y:  238.0 },
                                WorldPosition { x:  1978.0 , y:  354.0 },
                                WorldPosition { x:  1642.0 , y:  246.0 },
                            ],
                            waitings: vec![
                                ...
                                Waiting {
                                    position: WorldPosition { x:  2740.0 , y:  238.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
        ...
        Level::Canyon => {
            Some(
                vec![ 
                    GuardBundle { 
                        position: WorldPosition { x:  2964.0 , y:  600.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2964.0 , y:  600.0 },
                                WorldPosition { x:  3207.0 , y:  601.0 },
                                WorldPosition { x:  3207.0 , y:  657.0 },
                                WorldPosition { x:  3260.0 , y:  383.0 },
                                WorldPosition { x:  3260.0 , y:  201.0 },
                                WorldPosition { x:  3260.0 , y:  383.0 },
                                WorldPosition { x:  3034.0 , y:  383.0 },
                                WorldPosition { x:  3034.0 , y:  201.0 },
                                WorldPosition { x:  3034.0 , y:  600.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  2964.0 , y:  600.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  3207.0 , y:  657.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                                Waiting {
                                    position: WorldPosition { x:  3260.0 , y:  201.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                                Waiting {
                                    position: WorldPosition { x:  3034.0 , y:  201.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  2015.0 , y:  559.0 },
                        orientation: Orientation(Quat::from_rotation_z(7.0*PI/6.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                            run_timer: Timer::new(Duration::from_millis(250), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2015.0 , y:  559.0 },
                                WorldPosition { x:  2126.0 , y:  620.0 },
                                WorldPosition { x:  2907.0 , y:  620.0 },
                                WorldPosition { x:  2126.0 , y:  620.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                ...
                                Waiting {
                                    position: WorldPosition { x:  2907.0 , y:  620.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  942.0 , y:  1488.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  942.0 , y:  1488.0 },
                                WorldPosition { x:  942.0 , y:  1166.0 },
                                WorldPosition { x:  1105.0 , y:  1026.0 },
                                WorldPosition { x:  942.0 , y:  1166.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                ...
                                Waiting {
                                    position: WorldPosition { x:  1105.0 , y:  1026.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  2839.0 , y:  1536.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2839.0 , y:  1536.0 },
                                WorldPosition { x:  2839.0 , y:  1420.0 },
                                WorldPosition { x:  2642.0 , y:  1301.0 },
                                WorldPosition { x:  2553.0 , y:  1301.0 },
                                WorldPosition { x:  2834.0 , y:  1134.0 },
                                WorldPosition { x:  2834.0 , y:  1086.0 },
                                WorldPosition { x:  3002.0 , y:  1208.0 },
                                WorldPosition { x:  3002.0 , y:  1338.0 },
                                WorldPosition { x:  2839.0 , y:  1420.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                ...
                                Waiting {
                                    position: WorldPosition { x:  2553.0 , y:  1301.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                                Waiting {
                                    position: WorldPosition { x:  2834.0 , y:  1086.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  2295.0 , y:  1754.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  2295.0 , y:  1754.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  2295.0 , y:  1754.0 },
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  1996.0 , y:  878.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  1996.0 , y:  878.0 },
                                WorldPosition { x:  2747.0 , y:  878.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  1996.0 , y:  878.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  2747.0 , y:  878.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  1831.0 , y:  1508.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  1831.0 , y:  1508.0 },
                                WorldPosition { x:  1831.0 , y:  1123.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  1831.0 , y:  1508.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  1831.0 , y:  1123.0 },
                                    time: Timer::from_seconds(1.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  453.0 , y:  1910.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  453.0 , y:  1910.0 },
                                WorldPosition { x:  257.0 , y:  1733.0 },
                                WorldPosition { x:  257.0 , y:  1035.0 },
                                WorldPosition { x:  748.0 , y:  1035.0 },
                                WorldPosition { x:  857.0 , y:  1135.0 },
                                WorldPosition { x:  748.0 , y:  1035.0 },
                                WorldPosition { x:  257.0 , y:  1035.0 },
                                WorldPosition { x:  257.0 , y:  1733.0 },
                            ],
                            waitings: vec![
                                ...
                                Waiting {
                                    position: WorldPosition { x:  857.0 , y:  1135.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
                    ...
                    GuardBundle { 
                        position: WorldPosition { x:  1155.0 , y:  436.0 },
                        orientation: Orientation(Quat::from_rotation_z(PI/2.0)),
                        pace: GuardPace::Walk,
                        animation: AnimatedMotion {
                            walk_timer: Timer::new(Duration::from_millis(500), TimerMode::Repeating),
                        ...
                        patrol: Patrol {
                            positions: vec![
                                WorldPosition { x:  1155.0 , y:  436.0 },
                                WorldPosition { x:  546.0 , y:  710.0 },
                            ],
                            waitings: vec![
                                Waiting {
                                    position: WorldPosition { x:  1155.0 , y:  436.0 },
                                ...
                                Waiting {
                                    position: WorldPosition { x:  546.0 , y:  710.0 },
                                    time: Timer::from_seconds(2.0, TimerMode::Repeating),
                                },
                            ],
                            position_index: 0, 
